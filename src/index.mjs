...
const readInput = (day) =>
  readFileSync(`./src/${("" + day).padStart(2, "0")}-input.txt`).toString();
...
const day04Data = day04.parseData(readInput(3));
...
const day05Data = day05.parseData(readInput(3));
...
const day06Data = day06.parseData(readInput(3));
...
const day07Data = day07.parseData(readInput(3));
...
const day08Data = day08.parseData(readInput(3));
...
const day09Data = day09.parseData(readInput(3));
...
const day10Data = day10.parseData(readInput(3));
...
const day11Data = day11.parseData(readInput(3));
...
const day12Data = day12.parseData(readInput(3));
...
const day13Data = day13.parseData(readInput(3));
...
const day14Data = day14.parseData(readInput(3));
...
const day15Data = day15.parseData(readInput(3));
...
const day16Data = day16.parseData(readInput(3));
...
const day17Data = day17.parseData(readInput(3));
...
const day18Data = day18.parseData(readInput(3));
...
const day19Data = day19.parseData(readInput(3));
...
const day20Data = day20.parseData(readInput(3));
...
const day21Data = day21.parseData(readInput(3));
...
const day22Data = day22.parseData(readInput(3));
...
const day23Data = day23.parseData(readInput(3));
...
const day24Data = day24.parseData(readInput(3));
