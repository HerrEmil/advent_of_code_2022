...
console.log(`Day 03, puzzle 1 answer: ${day03.part1(day03Data)}`); // 7967
console.log(`Day 03, puzzle 2 answer: ${day03.part2(day03Data)}`); // 2716
...
console.log(`Day 08, puzzle 1 answer: ${day08.part1(day08Data)}`); // 1851
console.log(`Day 08, puzzle 2 answer: ${day08.part2(day08Data)}`); // 574080

import * as day09 from "./09.mjs";
const day09Data = day09.parseData(readInput(9));
console.log(`Day 09, puzzle 1 answer: ${day09.part1(day09Data)}`); // 5930
console.log(`Day 09, puzzle 2 answer: ${day09.part2(day09Data)}`); // 2443

import * as day10 from "./10.mjs";
const day10Data = day10.parseData(readInput(10));
console.log(`Day 10, puzzle 1 answer: ${day10.part1(day10Data)}`); // 14560
console.log(`Day 10, puzzle 2 answer:
${day10.part2(day10Data)}`); // EKRHEPUZ
...
console.log(`Day 13, puzzle 1 answer: ${day13.part1(day13Data)}`); // 29141 too high, 8601 wrong, 5589 wrong
